...
import { Scroll, ScrollControls, Environment, Sparkles, Backdrop, Float, Ring } from "@react-three/drei";
      ...
      <ScrollControls pages={6} damping={0.3}>
        ...
        >
          <Ring scale={3.5} position-z={-2.5} position-y={-1} args={[0, 0.95, 60]} receiveShadow>
            <meshPhysicalMaterial color="#2a3a3f" />
          </Ring>
        </Float>
        <Scroll>
        </Scroll>
        <Scroll html style={{ width: "100vw" }}>
          ...
          <a href="https://github.com/Jameshterrance">

            <button style={{ position: 'absolute', top: `590vh`, left: '50%', transform: `translate(-50%,-50%)`, cursor: `pointer` }}>Click Here</button>
          </a>
        </Scroll>
      </ScrollControls>
    </>
